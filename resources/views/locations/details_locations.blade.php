        ...
        <div class="bg-white min-h-screen">
            ...
            <div class="p-4 sm:p-6">
                ...
                <div class="rounded-2xl bg-gradient-to-b from-blue-100 to-blue-50 py-10 text-center mb-4">
                    ...
                    <p class="text-sm font-semibold text-blue-700 px-4 break-words">
                        {{ $location->address }}
                    </p>
                ...
                <div class="rounded-2xl border border-gray-200 p-4 mb-4">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 mb-3">
                        ...
                        <span
                            class="self-start shrink-0 text-xs font-medium px-2.5 py-1 rounded-full
                            {{ $location->is_open
                    ...
                    <div class="space-y-3 text-sm text-gray-500">
                        ...
                        <div class="flex items-start gap-2">
                            ...
                            <svg
                                class="w-4 h-4 mt-0.5 text-blue-500 shrink-0"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor"
                                stroke-width="2"
                    ...
                    @if($location->description)
                        ...
                        <p class="text-sm text-gray-400 mt-3 break-words">
                ...
                <a
                    href="#"
                    class="w-full flex items-center justify-center gap-2 rounded-2xl
                ...
                >
                    ...
                    >
                        <path
                            stroke-linecap="round"
                            stroke-linejoin="round"
                            d="M8 11V7a4 4 0 118 0m-8 4h8a2 2 0 012 2v5a2 2 0 01-2 2H8a2 2 0 01-2-2v-5a2 2 0 012-2z"
                        />
                    </svg>
